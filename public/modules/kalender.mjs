...
export function initKalender(revisorhus, revisor){
...
export function hentDataForUgedage() {

    //Find dage med ledige tider, og giv den classen 'ledig' og 'optaget'
    console.log(visKalenderFor);
    var revisorMøder = visKalenderFor.getMøder();
    møderDenneMåned = [];
