...
const Revisor = User.discriminator("Revisor", new mongoose.Schema({
    //Vi skal lige beslutte os for string eller number, nedenfor er to forskellige måder at validere
        startDag: {type: String, required: true, enum: ["06:00","06:15","06:30","06:45","07:00","07:15","07:30","07:45","08:00","08:15","08:30","08:45",
                "09:00","09:15","09:30","09:45","10:15","10:30","10:45","11:00","11:15","11:30","11:45","12:00","12:15","12:30","12:45","13:00","13:15",
        ...
        slutDag: {type: Number, required: true, min: 559, max: 2359}
    }),
);
